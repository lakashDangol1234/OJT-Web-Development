...
<nav class="navbar navbar-expand-lg <?php
    ...
    <div class="container-fluid">
        <a class="navbar-brand" href="/lakashojt/day_29_to_day_un_oop/index.php">OJT Project</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link" id="home" aria-current="page" href="/lakashojt/day_29_to_day_un_oop/index.php">Home</a>
                </li>
                <li class="nav-item">
                ...
                if (isset($_SESSION['admin']) && $_SESSION['admin'] == true) {
                    echo '<li class="nav-item">
                     <a class="nav-link" id="addStudent" href="/lakashojt/day_29_to_day_un_oop/admin/addStudent.php">
                ...
                <li class="nav-item">
                     <a class="nav-link" id="showStudent" href="/lakashojt/day_29_to_day_un_oop/admin/showStudent.php">Show Student</a>
                 </li>
                ';
                }
                ?>
            ...
            <div class="d-flex justify-content-between">
                ...
                if (isset($_SESSION['username'])) {
                    echo '<div class="d-flex justify-content-around align-items-center bg-primary me-3 px-2" style="border-radius:5px;">
                        <img src="/lakashojt/day_29_to_day_un_oop/images/default_userImage.png" alt="userImage" class="img-fluid" width="40">
                        <p class="text-light m-0 ms-2">' . $_SESSION['username'] . '</p>
                    </div>
                
                    <a type="button" href="/lakashojt/day_29_to_day_un_oop/partials/_handleLogout.php" class="btn btn-' . ($_SESSION['navbarTheme'] == "danger" ? "secondary" : "danger") . '">
                    ...
                    echo '<a href="/lakashojt/day_29_to_day_un_oop/signupPage.php" class="btn btn-danger mx-3">Sign Up</a>
                    <a href="/lakashojt/day_29_to_day_un_oop/loginPage.php" class="btn btn-danger">Login</a>';
                }
                ?>
