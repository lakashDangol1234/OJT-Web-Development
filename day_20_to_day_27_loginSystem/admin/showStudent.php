    ...
    <div class="modal fade" id="editStudentModal" tabindex="-1" aria-labelledby="editStudentModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form id="editStudentForm" action="/lakashojt/day_20_to_day_un_loginSystem/partials/_handleEdit.php" method="POST">
    ...
    <div class="modal fade" id="deleteStudentModal" tabindex="-1" aria-labelledby="deleteStudentModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form id="deleteStudentForm" action="/lakashojt/day_20_to_day_un_loginSystem/partials/_handleDelete.php" method="POST">
                    <div class="modal-body">
